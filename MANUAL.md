...
หลังออกบัตร รายการบัตรจะแสดง `สถานะ LINE`:

- `ยังไม่ส่ง` คือยังไม่ได้ส่ง LINE OA หรือไม่ได้ติ๊กส่ง LINE
- `ส่งแล้ว` คือส่งข้อความ/QR ผ่าน LINE OA สำเร็จ
- `ส่งไม่สำเร็จ` คือ LINE OA ส่งไม่ผ่าน และระบบจะแสดง error ไว้ในรายการบัตร

สถานะนี้มองเห็นได้ทั้งบัญชี `admin` และ `issuer`
...
9. ลูกค้าเปิด `ticket.html` ได้
10. LINE OA ส่งข้อความและรูป QR ได้
